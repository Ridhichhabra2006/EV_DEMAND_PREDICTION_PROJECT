...
# === Forecasting ===
historical_ev = list(county_df['EV_Total'].values[-6:])
...
historical_cum = county_df[['Date', 'EV_Total']].copy()
historical_cum['Source'] = 'Historical'
historical_cum['Cumulative EV'] = historical_cum['EV_Total'].cumsum()
...
if multi_counties:
    ...
    for cty in multi_counties:
        ...
        hist_ev = list(cty_df['EV_Total'].values[-6:])
        ...
        hist_cum = cty_df[['Date', 'EV_Total']].copy()
        hist_cum['Cumulative EV'] = hist_cum['EV_Total'].cumsum()
